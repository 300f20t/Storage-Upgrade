...
public class LaserCable4Block extends Block {
	...
	public VoxelShape getShape(BlockState state, BlockGetter world, BlockPos pos, CollisionContext context) {
		return switch (state.getValue(FACING)) {
			default -> Shapes.or(box(6, 0, 6, 10, 10, 10), box(6, 6, 10, 10, 10, 16));
			case NORTH -> Shapes.or(box(6, 0, 6, 10, 10, 10), box(6, 6, 0, 10, 10, 6));
			case EAST -> Shapes.or(box(6, 0, 6, 10, 10, 10), box(10, 6, 6, 16, 10, 10));
			case WEST -> Shapes.or(box(6, 0, 6, 10, 10, 10), box(0, 6, 6, 6, 10, 10));
		};
	}

...
public class LaserCable5Block extends Block {
	...
	public VoxelShape getShape(BlockState state, BlockGetter world, BlockPos pos, CollisionContext context) {
		return switch (state.getValue(FACING)) {
			default -> Shapes.or(box(7, 7, 7, 9, 9, 16), box(0, 7, 7, 7, 9, 9), box(6, 6, 9, 7, 7, 16), box(6, 9, 9, 7, 10, 16), box(9, 9, 6, 10, 10, 16), box(9, 6, 6, 10, 7, 16), box(0, 6, 9, 6, 7, 10), box(0, 6, 6, 9, 7, 7), box(0, 9, 6, 9, 10, 7),
					box(0, 9, 9, 6, 10, 10));
			case NORTH -> Shapes.or(box(7, 7, 0, 9, 9, 9), box(9, 7, 7, 16, 9, 9), box(9, 6, 0, 10, 7, 7), box(9, 9, 0, 10, 10, 7), box(6, 9, 0, 7, 10, 10), box(6, 6, 0, 7, 7, 10), box(10, 6, 6, 16, 7, 7), box(7, 6, 9, 16, 7, 10),
					box(7, 9, 9, 16, 10, 10), box(10, 9, 6, 16, 10, 7));
			case EAST -> Shapes.or(box(7, 7, 7, 16, 9, 9), box(7, 7, 9, 9, 9, 16), box(9, 6, 9, 16, 7, 10), box(9, 9, 9, 16, 10, 10), box(6, 9, 6, 16, 10, 7), box(6, 6, 6, 16, 7, 7), box(9, 6, 10, 10, 7, 16), box(6, 6, 7, 7, 7, 16),

...
public class LaserCable6Block extends Block {
	...
	public VoxelShape getShape(BlockState state, BlockGetter world, BlockPos pos, CollisionContext context) {
		return switch (state.getValue(FACING)) {
			...
			case UP -> Shapes.or(box(7, 7, 7, 9, 16, 9), box(7, 7, 9, 9, 9, 16), box(9, 9, 9, 10, 16, 10), box(6, 9, 9, 7, 16, 10), box(6, 6, 6, 7, 16, 7), box(9, 6, 6, 10, 16, 7), box(9, 9, 10, 10, 10, 16), box(9, 6, 7, 10, 7, 16),
					box(6, 6, 7, 7, 7, 16), box(6, 9, 10, 7, 10, 16));
			case DOWN -> Shapes.or(box(7, 0, 7, 9, 9, 9), box(7, 7, 0, 9, 9, 7), box(9, 0, 6, 10, 7, 7), box(6, 0, 6, 7, 7, 7), box(6, 0, 9, 7, 10, 10), box(9, 0, 9, 10, 10, 10), box(9, 6, 0, 10, 7, 6), box(9, 9, 0, 10, 10, 9),
					box(6, 9, 0, 7, 10, 9), box(6, 6, 0, 7, 7, 6));
		};
	}
